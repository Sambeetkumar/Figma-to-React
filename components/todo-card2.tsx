...
const TodoCard2: NextPage = () => {
  return (
    <div className="absolute top-[986px] left-[319px] rounded-2xl bg-white w-[314px] h-[177px] text-left text-xs text-slategray font-inter">
      <div className="absolute top-[133px] left-[20px] w-[274px] h-6 flex flex-row items-center justify-start gap-[43px]">
        <img className="relative w-[63px] h-6" alt="" src="/group-6332.svg" />
        <div className="relative w-[168px] h-4">
          <img
