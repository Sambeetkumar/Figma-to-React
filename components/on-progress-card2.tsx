...
const OnProgressCard2: NextPage = () => {
  return (
    <div className="absolute top-[923px] left-[689px] rounded-2xl bg-white w-[314px] h-[177px] text-left text-xs text-gray font-inter">
      <div className="absolute top-[133px] left-[20px] w-[274px] h-6 flex flex-row items-center justify-start gap-[37px] text-slategray">
        <img className="relative w-[63px] h-6" alt="" src="/group-6334.svg" />
...
export default OnProgressCard2;
